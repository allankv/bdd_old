<!-- Set names -->
<?php $field = 'Type of stand'; ?>
<?php $field_plural = 'Types of stand'; ?>

<script>
    $(document).ready(bootTypeStand)

    function bootTypeStand() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idtypestand;?>", "<?php echo $ar->typestand; ?>");
        <?php endforeach; ?>
