<!-- Set names -->
<?php $field = 'Subspecies'; ?>
<?php $field_plural = 'Subspecies'; ?>

<script>
    $(document).ready(bootSubspecies)

    function bootSubspecies() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idsubspecies;?>", "<?php echo $ar->subspecies; ?>");
        <?php endforeach; ?>
