<!-- Set names -->
<?php $field = 'Plant Species'; ?>
<?php $field_plural = 'Plant Species'; ?>

<script>
    $(document).ready(bootPlantSpecies)

    function bootPlantSpecies() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idplantspecies;?>", "<?php echo $ar->plantspecies; ?>", "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
