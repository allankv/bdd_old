<!-- Set names -->
<?php $field = 'Recorded By'; ?>
<?php $field_plural = 'Recorded Bys'; ?>
...
<script>
    ...
    function bootRecordedBy() {
        ...
        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idrecordedby;?>", "<?php echo $ar->recordedby; ?>", "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
