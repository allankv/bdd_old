<!-- Set names -->
<?php $field = 'Identified By'; ?>
<?php $field_plural = 'Identified Bys'; ?>
...
<script>
    ...
    function bootIdentifiedBy() {
        ...
        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->ididentifiedby;?>", "<?php echo $ar->identifiedby; ?>",  "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
