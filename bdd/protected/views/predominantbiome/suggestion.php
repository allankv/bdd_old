<!-- Set names -->
<?php $field = 'PredominantBiome'; ?>
<?php $field_plural = 'PredominantBiomes'; ?>

<script>
    $(document).ready(bootPredominantBiome)

    function bootPredominantBiome() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idpredominantbiome;?>", "<?php echo $ar->predominantbiome; ?>");
        <?php endforeach; ?>
