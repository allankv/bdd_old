<!-- Set names -->
<?php $field = 'State or province'; ?>
<?php $field_plural = 'States or provinces'; ?>

<script>
    $(document).ready(bootStateProvince)

    function bootStateProvince() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idstateprovince;?>", "<?php echo $ar->stateprovince; ?>");
        <?php endforeach; ?>
