<!-- Set names -->
<?php $field = 'Afiliation'; ?>
<?php $field_plural = 'Afiliations'; ?>

<script>
    $(document).ready(bootAfiliation)

    function bootAfiliation() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idafiliation;?>", "<?php echo $ar->afiliation; ?>", "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
