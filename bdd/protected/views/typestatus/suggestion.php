<!-- Set names -->
<?php $field = 'Type Status'; ?>
<?php $field_plural = 'Type Statuses'; ?>
...
<script>
    ...
    function bootTypeStatus() {
        ...
        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idtypestatus;?>", "<?php echo $ar->typestatus; ?>",  "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
