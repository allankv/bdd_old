<!-- Set names -->
<?php $field = 'Production variety'; ?>
<?php $field_plural = 'Production varieties'; ?>

<script>
    $(document).ready(bootProductionVariety)

    function bootProductionVariety() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idproductionvariety;?>", "<?php echo $ar->productionvariety; ?>");
        <?php endforeach; ?>
