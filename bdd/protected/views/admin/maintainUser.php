...
<script type="text/javascript">	
    ...
    function save(){
    	...
    	$.ajax({ type:'POST',
    	    url:'index.php?r=admin/saveUsers',
    	    data: $("#form").serialize(),
    	    dataType: "json",
    	    success:function(json) {
    	       ...
    	       if (json.success) {
    	       		window.location.replace("index.php?r=admin/goToListUsers");
    	       }
...
<div class="introText">
    <h1><?php echo $ar->idUser != null ? Yii::t('yii', 'Update an existing user record') : Yii::t('yii', 'Create a new user record'); ?></h1>
...
<?php echo CHtml::activeHiddenField($ar, 'idUser'); ?>
    ...
    <div id="contentSpecimen">
      ...
      <div class="tablerow" id='divsubtypereference'>
            <tr>
				...
				<?php echo CHtml::activeLabel(groups::model(), 'group'); ?>
                ...
                <td class="tablefieldcel">
					<?php echo CHtml::activeDropDownList($ar, 'idGroup', CHtml::listData(groups::model()->findAll(" 1=1 ORDER BY \"group\" "), 'idGroup', 'group'), array('empty' => '-')); ?>
                </td>
            </tr>
        </div>
        ...
        <div class="tablerow" id='divtitle'>
            <tr>
                <td class="tablelabelcel">
					<div style="margin-left:30px;"> <?php echo CHtml::activeLabel($ar, "Username"); ?>
				...
				<td class="tablefieldcel">
					<?php echo CHtml::activeTextField($ar, 'username', array('class' => 'textboxtext')); ?>
				 </td>
			 </tr>
		</div>
		...
		<div class="tablerow" id='divtitle'>
            <tr>
                <td class="tablelabelcel">
					<div style="margin-left:30px;"> <?php echo CHtml::activeLabel($ar, "Email"); ?>
					<span class="required">*</span> </div>
				</td>
				<td class="tablemiddlecel">
					<?php echo CHtml::link('<image style border=\'0px\' src="images/help.gif">', 'index.php?r=help&helpfield=title', array('rel' => 'lightbox')); ?>
				...
				<td class="tablefieldcel">
					<?php echo CHtml::activeTextField($ar, 'email', array('class' => 'textboxtext')); ?>
				 </td>
			 </tr>
		</div>
		...
		<div class="tablerow" id='divtitle'>
            <tr>
                <td class="tablelabelcel">
					<div style="margin-left:30px;"> <?php echo CHtml::activeLabel($ar, "Password"); ?>
					<span class="required">*</span> </div>
				</td>
				<td class="tablemiddlecel">
					<?php echo CHtml::link('<image style border=\'0px\' src="images/help.gif">', 'index.php?r=help&helpfield=title', array('rel' => 'lightbox')); ?>
				...
				<td class="tablefieldcel">
					<?php echo CHtml::activePasswordField($ar, 'password', array('class' => 'textboxtext')); ?>
				 </td>
			 </tr>
		</div>
