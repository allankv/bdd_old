<!-- Set names -->
<?php $field = 'Related Name'; ?>
<?php $field_plural = 'Related Names'; ?>
<?php //$controllerItem = 'relatedname'?>

<script>
    $(document).ready(bootRelatedName)

    function bootRelatedName() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idrelatedname;?>", "<?php echo $ar->relatedname; ?>", "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
