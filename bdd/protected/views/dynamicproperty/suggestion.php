<!-- Set names -->
<?php $field = 'Dynamic Property'; ?>
<?php $field_plural = 'Dynamic Properties'; ?>
...
<script>
    ...
    function bootDynamicProperty() {
        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->iddynamicproperty;?>", "<?php echo $ar->dynamicproperty; ?>", "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
