<!-- Set names -->
<?php $field = 'Scientific Name Authorship'; ?>
<?php $field_plural = 'Scientific Name Authorships'; ?>

<script>
    $(document).ready(bootSNA)

    function bootSNA() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idscientificnameauthorship;?>", "<?php echo $ar->scientificnameauthorship; ?>");
        <?php endforeach; ?>
