<div class="yiiForm" style="background-color: transparent; border: none;">
        ...
        <div class="tablerownewbox">
            <?php echo CHtml::errorSummary($model); ?>
                ...
                <div class="tablelabelcelnewbox">
                    ...
                    <?php echo CHtml::label(Yii::t('yii','Parent name usage'), "parentnameusage",  array());?>
        ...
        <div class="tablerownewbox">
                <div class="tablefieldcelnewbox">
                    <div class="fieldnewbox">
                        <?php echo CHtml::activeTextField($model,'parentnameusage',array('rows'=>6, 'cols'=>50, 'size'=>48)); ?>
                    </div>
                </div>
    ...
    <div class="actionnewbox">
		...
		array('success'=>"alert('funfou o ajax')")
            ...
            <input type="button" value="<?php echo Yii::t('yii', "Create");?>" onclick="insertDataTaxonomicElements($('#parentnameusage'),$('#taxonomicelements_idparentnameusage'),'index.php?r=parentnameusage/create'+concatenarValoresUrlTaxonomicElements(),'parentnameusage='+document.getElementById('parentnameusage_parentnameusage').value)" >
