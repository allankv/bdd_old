<!-- Set names -->
<?php $field = 'Plant Common Name'; ?>
<?php $field_plural = 'Plant Common Names'; ?>

<script>
    $(document).ready(bootPlantCommonName)

    function bootPlantCommonName() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idplantcommonname;?>", "<?php echo $ar->plantcommonname; ?>", "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
