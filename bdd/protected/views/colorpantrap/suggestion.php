<!-- Set names -->
<?php $field = 'ColorPanTrap'; ?>
<?php $field_plural = 'ColorPanTraps'; ?>

<script>
    $(document).ready(bootColorPanTrap)

    function bootColorPanTrap() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idcolorpantrap;?>", "<?php echo $ar->colorpantrap; ?>");
        <?php endforeach; ?>
