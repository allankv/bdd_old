<!-- Set names -->
<?php $field = 'Identification Qualifier'; ?>
<?php $field_plural = 'Identification Qualifiers'; ?>
...
<script>
    ...
    function bootIdentificationQualifier() {
        ...
        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->ididentificationqualifier;?>", "<?php echo $ar->identificationqualifier; ?>");
        <?php endforeach; ?>
