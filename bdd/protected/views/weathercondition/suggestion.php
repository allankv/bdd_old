<!-- Set names -->
<?php $field = 'Weather condition'; ?>
<?php $field_plural = 'Weather conditions'; ?>

<script>
    $(document).ready(bootWeatherCondition)

    function bootWeatherCondition() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idweathercondition;?>", "<?php echo $ar->weathercondition; ?>");
        <?php endforeach; ?>
