<!-- Set names -->
<?php $field = 'Common name of focal crop'; ?>
<?php $field_plural = 'Common names of focal crops'; ?>

<script>
    $(document).ready(bootCommonNameFocalCrop)

    function bootCommonNameFocalCrop() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idcommonnamefocalcrop;?>", "<?php echo $ar->commonnamefocalcrop; ?>");
        <?php endforeach; ?>
