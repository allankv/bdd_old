<!-- Set names -->
<?php $field = 'Main plant species in the hedge'; ?>
<?php $field_plural = 'Main plant species in hedges'; ?>

<script>
    $(document).ready(bootMainPlantSpeciesInHedge)

    function bootMainPlantSpeciesInHedge() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idmainplantspeciesinhedge;?>", "<?php echo $ar->mainplantspeciesinhedge; ?>");
        <?php endforeach; ?>
