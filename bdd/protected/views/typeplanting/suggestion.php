<!-- Set names -->
<?php $field = 'Type of planting'; ?>
<?php $field_plural = 'Types of planting'; ?>

<script>
    $(document).ready(bootTypePlanting)

    function bootTypePlanting() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idtypeplanting;?>", "<?php echo $ar->typeplanting; ?>");
        <?php endforeach; ?>
