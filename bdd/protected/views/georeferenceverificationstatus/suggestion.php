<!-- Set names -->
<?php $field = 'Georeference Verification Status'; ?>
<?php $field_plural = 'Georeference Verification Statuses'; ?>

<script>
    $(document).ready(bootVerificationStatus)

    function bootVerificationStatus() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idgeoreferenceverificationstatus;?>", "<?php echo $ar->georeferenceverificationstatus; ?>");
        <?php endforeach; ?>
