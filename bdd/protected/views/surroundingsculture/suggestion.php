<!-- Set names -->
<?php $field = 'Surroundings Culture'; ?>
<?php $field_plural = 'Surroundings Cultures'; ?>

<script>
    $(document).ready(bootSurroundingsCulture)

    function bootSurroundingsCulture() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idsurroundingsculture;?>", "<?php echo $ar->surroundingsculture; ?>");
        <?php endforeach; ?>
