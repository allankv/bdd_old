<!-- To create new field, use template and replace, for example:
"TemplateUpperCase" with "ScientificName" AND
"templatelowercase" with "scientificname" -->

<!-- Set names -->
<?php $field = ''; ?> <!-- Name of field in singular -->
<?php $field_plural = ''; ?> <!-- Name of field in plural -->

<script>
    $(document).ready(bootTemplateUpperCase)

    function bootTemplateUpperCase() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idtemplatelowercase;?>", "<?php echo $ar->templatelowercase; ?>");
        <?php endforeach; ?>
