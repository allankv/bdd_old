<!-- Set names -->
<?php $field = 'Reproductive Condition'; ?>
<?php $field_plural = 'Reproductive Conditions'; ?>
...
<script>
    ...
    function bootLocality() {
        ...
        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idreproductivecondition;?>", "<?php echo $ar->reproductivecondition; ?>");
        <?php endforeach; ?>
