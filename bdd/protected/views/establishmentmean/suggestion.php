<!-- Set names -->
<?php $field = 'Establishment Means'; ?>
<?php $field_plural = 'Establishment Means'; ?>

<script>
    $(document).ready(bootEstablishmentMeans)

    function bootEstablishmentMeans() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idestablishmentmean;?>", "<?php echo $ar->establishmentmean; ?>");
        <?php endforeach; ?>
