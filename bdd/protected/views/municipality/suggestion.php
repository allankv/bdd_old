<!-- Set names -->
<?php $field = 'Municipality'; ?>
<?php $field_plural = 'Municipalities'; ?>

<script>
    $(document).ready(bootMunicipality)

    function bootMunicipality() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idmunicipality;?>", "<?php echo $ar->municipality; ?>");
        <?php endforeach; ?>
