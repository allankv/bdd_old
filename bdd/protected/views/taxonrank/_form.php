<div class="yiiForm" style="background-color: transparent; border: none;">
            ...
            <?php echo CHtml::errorSummary($model); ?>
                ...
                <div class="tablelabelcelnewbox">
                    <div class="labelnewbox">
                        ...
                        echo CHtml::label(Yii::t('yii','Taxon rank'), "taxonranks");
                        ?>
        ...
        <div class="tablerownewbox">
                <div class="tablefieldcelnewbox">
                    <div class="fieldnewbox">
                        <?php echo CHtml::activeTextField($model,'taxonrank',array('rows'=>6, 'cols'=>50, 'size'=>48)); ?>
                    </div>
                </div>
    ...
    <div class="actionnewbox">
        ...
        <input type="button" value="<?php echo Yii::t('yii', "Create");?>" onclick="insertDataTaxonomicElements($('#taxonrank'),$('#taxonomicelements_idtaxonrank'),'index.php?r=taxonranks/create'+concatenarValoresUrlTaxonomicElements(),'taxonrank='+document.getElementById('taxonranks_taxonrank').value)" >
   </div>
