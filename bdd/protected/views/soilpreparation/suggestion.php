<!-- Set names -->
<?php $field = 'Soil preparation'; ?>
<?php $field_plural = 'Soil preparations'; ?>

<script>
    $(document).ready(bootSoilPreparation)

    function bootSoilPreparation() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idsoilpreparation;?>", "<?php echo $ar->soilpreparation; ?>");
        <?php endforeach; ?>
