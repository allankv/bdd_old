<div class="yiiForm" style="background-color: transparent; border: none;">
    ...
    <div class="tablenewbox">
        <div class="tablerownewbox">
            <?php echo CHtml::errorSummary($kingdoms); ?>

                <div class="tablelabelcelnewbox">
                    <div class="labelnewbox">
                    <?php echo CHtml::label(Yii::t('yii','Kingdom'), "kingdoms",  array());?>
        ...
        <div class="tablerownewbox">
                <div class="tablefieldcelnewbox">
                    <div class="fieldnewbox">
                        <?php echo CHtml::activeTextField($kingdoms,'kingdom',array('rows'=>6, 'cols'=>50, 'size'=>48)); ?>
                    </div>
                </div>
    ...
    <div class="actionnewbox">
		...
		array('success'=>"alert('funfou o ajax')")
            ...
            <input type="button" value="<?php echo Yii::t('yii', "Create");?>" onclick="insertDataTaxonomicElements($('#kingdom'),$('#taxonomicelements_idkingdom'),'index.php?r=kingdoms/create'+concatenarValoresUrlTaxonomicElements(),'kingdom='+document.getElementById('kingdoms_kingdom').value)" >
