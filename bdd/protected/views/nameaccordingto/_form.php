<div class="yiiForm" style="background-color: transparent; border: none;">
        ...
        <div class="tablerownewbox">
            <?php echo CHtml::errorSummary($model); ?>
                ...
                <div class="tablelabelcelnewbox">
                    ...
                    <?php echo CHtml::label(Yii::t('yii','Name according to'), "nameaccordingto",  array());?>
        ...
        <div class="tablerownewbox">
                <div class="tablefieldcelnewbox">
                    <div class="fieldnewbox">
                        <?php echo CHtml::activeTextField($model,'nameaccordingto',array('rows'=>6, 'cols'=>50, 'size'=>48)); ?>
                    </div>
                </div>
    ...
    <div class="actionnewbox">
		...
		array('success'=>"alert('funfou o ajax')")
            ...
            <input type="button" value="<?php echo Yii::t('yii', "Create");?>" onclick="insertDataTaxonomicElements($('#nameaccordingto'),$('#taxonomicelements_idnameaccordingto'),'index.php?r=nameaccordingto/create'+concatenarValoresUrlTaxonomicElements(),'nameaccordingto='+document.getElementById('nameaccordingto_nameaccordingto').value)" >
