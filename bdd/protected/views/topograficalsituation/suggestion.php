<!-- Set names -->
<?php $field = 'Topografical situation'; ?>
<?php $field_plural = 'Topografical situations'; ?>

<script>
    $(document).ready(bootTopograficalSituation)

    function bootTopograficalSituation() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idtopograficalsituation;?>", "<?php echo $ar->topograficalsituation; ?>");
        <?php endforeach; ?>
