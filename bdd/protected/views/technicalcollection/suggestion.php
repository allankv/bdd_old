<!-- Set names -->
<?php $field = 'TechnicalCollection'; ?>
<?php $field_plural = 'TechnicalCollections'; ?>

<script>
    $(document).ready(bootTechnicalCollection)

    function bootTechnicalCollection() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idtechnicalcollection;?>", "<?php echo $ar->technicalcollection; ?>");
        <?php endforeach; ?>
