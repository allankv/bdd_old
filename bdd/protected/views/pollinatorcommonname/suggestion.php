<!-- Set names -->
<?php $field = 'Pollinator Common Name'; ?>
<?php $field_plural = 'Pollinator Common Names'; ?>

<script>
    $(document).ready(bootPollinatorCommonName)

    function bootPollinatorCommonName() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idpollinatorcommonname;?>", "<?php echo $ar->pollinatorcommonname; ?>", "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
