<!-- Set names -->
<?php $field = 'Focus crop'; ?>
<?php $field_plural = 'Focus crops'; ?>

<script>
    $(document).ready(bootFocusCrop)

    function bootFocusCrop() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idfocuscrop;?>", "<?php echo $ar->focuscrop; ?>");
        <?php endforeach; ?>
