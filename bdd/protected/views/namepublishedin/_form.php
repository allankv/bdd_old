<div class="yiiForm" style="background-color: transparent; border: none;">
        ...
        <div class="tablerownewbox">
            <?php echo CHtml::errorSummary($model); ?>
                ...
                <div class="tablelabelcelnewbox">
                    ...
                    <?php echo CHtml::label(Yii::t('yii','Name published in'), "namepublishedin",  array());?>
        ...
        <div class="tablerownewbox">
                <div class="tablefieldcelnewbox">
                    <div class="fieldnewbox">
                        <?php echo CHtml::activeTextField($model,'namepublishedin',array('rows'=>6, 'cols'=>50, 'size'=>48)); ?>
                    </div>
                </div>
    ...
    <div class="actionnewbox">
		...
		array('success'=>"alert('funfou o ajax')")
            ...
            <input type="button" value="<?php echo Yii::t('yii', "Create");?>" onclick="insertDataTaxonomicElements($('#namepublishedin'),$('#taxonomicelements_idnamepublishedin'),'index.php?r=namepublishedin/create'+concatenarValoresUrlTaxonomicElements(),'namepublishedin='+document.getElementById('namepublishedin_namepublishedin').value)" >
