<!-- Set names -->
<?php $field = 'Creator'; ?>
<?php $field_plural = 'Creators'; ?>

<?php //$controllerItem = 'creator'?>
<script>
    $(document).ready(bootCreator)

    function bootCreator() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idcreator;?>", "<?php echo $ar->creator; ?>", "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
...
<div id="msgDoesNotExist" style="width: 500px; margin-top: 20px; margin-bottom: 20px; padding-left: 30px; padding-top: 0px ; float: left; color: #535353; font-size: 16px; font-family: Verdana;">
    <?php if ($term != "") echo $field.' "'.$term.'" does not exist.';?>
</div>

<div id="newRecordBox" class="yiiForm" style="width: 350px; float: left; margin-left: 50px; padding-left: 10px; padding-right: 10px;">
    <table cellspacing="0" cellpadding="0" align="center" class="tablerequired">
        ...
        <tr>
            ...
            <td class="tablefieldcel" width="100px" style="padding-right: 10px;">
                <input name="create" type="button" value="<?php echo Yii::t('yii', "Create");?>" onclick='createSuggestionNN("<?php echo $_field;?>",$("#valueTextField").val(),"<?php echo $controllerItem;?>", "<?php echo $controllerElement;?>")'/>
            </td>
        </tr>
...
<div id="msgConfirm" style="width: 500px; margin-top: 20px; margin-bottom: 0px; padding-left: 30px; padding-top: 0px ; float: left; color: #535353; font-size: 16px; font-family: Verdana; display: none;">
    <p>Please confirm author below.</p>
</div>
