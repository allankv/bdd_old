<!-- Set names -->
<?php $field = 'Synonym'; ?>
<?php $field_plural = 'Synonyms'; ?>
<?php //$controllerItem = 'synonym'; ?>

<script>
    $(document).ready(bootSynonym)

    function bootSynonym() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idsynonym;?>", "<?php echo $ar->synonym; ?>","<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
