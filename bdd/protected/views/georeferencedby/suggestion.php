<!-- Set names -->
<?php $field = 'Georeferenced By'; ?>
<?php $field_plural = 'Georeferenced Bys'; ?>
...
<script>
    ...
    function bootGeoreferencedBy() {
        ...
        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idgeoreferencedby;?>", "<?php echo $ar->georeferencedby; ?>", "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
    ...
    function insertLine(id, field, controllerItem, controllerElement)
    {
        ...
        line = line.replace('_URL_', 'javascript:selectSuggestion("<?php echo $_field;?>", "'+id+'", "'+field+'", "'+controllerItem+'", "'+controllerElement+'");');
    ...
    <table cellspacing="0" cellpadding="0" align="center" class="tablerequired">
        ...
        <tr>
            ...
            <td class="tablefieldcel" width="100px" style="padding-right: 10px;">
                <input name="create" type="button" value="<?php echo Yii::t('yii', "Create");?>" onclick='createSuggestion("<?php echo $_field;?>",$("#valueTextField").val(), "<?php echo $controllerItem;?>", "<?php echo $controllerElement;?>")'/>
            </td>
        </tr>
