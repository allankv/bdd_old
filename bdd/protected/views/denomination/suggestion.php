<!-- Set names -->
<?php $field = 'Denomination'; ?>
<?php $field_plural = 'Denominations'; ?>

<script>
    $(document).ready(bootDenomination)

    function bootDenomination() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->iddenomination;?>", "<?php echo $ar->denomination; ?>");
        <?php endforeach; ?>
