<div class="yiiForm" style="background-color: transparent; border: none;">
    ...
    <div class="tablenewbox">
        <div class="tablerownewbox">
            <?php echo CHtml::errorSummary($classes); ?>

                <div class="tablelabelcelnewbox">
                    <div class="labelnewbox">
                        <?php //echo CHtml::activeLabelEx($classes,'class');
                        echo CHtml::label(Yii::t('yii','Class'), "classes");
                        ?>
        ...
        <div class="tablerownewbox">
                <div class="tablefieldcelnewbox">
                    <div class="fieldnewbox">
                        <?php echo CHtml::activeTextField($classes,'class',array('rows'=>6, 'cols'=>50, 'size'=>48)); ?>
                    </div>
                </div>
    ...
    <div class="actionnewbox">
        ...
        <input type="button" value="<?php echo Yii::t('yii', "Create");?>" onclick="insertDataTaxonomicElements($('#class'),$('#taxonomicelements_idclass'),'index.php?r=classes/create'+concatenarValoresUrlTaxonomicElements(),'class='+document.getElementById('classes_class').value)" >
    </div>
