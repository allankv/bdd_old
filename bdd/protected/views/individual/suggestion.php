<!-- Set names -->
<?php $field = 'Individual'; ?>
<?php $field_plural = 'Individuals'; ?>
...
<script>
    ...
    function bootIndividual() {
        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idindividual;?>", "<?php echo $ar->individual; ?>", "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
