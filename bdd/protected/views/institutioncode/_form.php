<div class="yiiForm" style="background-color: transparent; border: none;">
    ...
    <div class="tablenewbox">
        <div class="tablerownewbox">
            <?php echo CHtml::errorSummary($institutioncodes); ?>

                <div class="tablelabelcelnewbox">
                    <div class="labelnewbox">
                        <?php //echo CHtml::activeLabelEx($institutioncodes,'institutioncode');
                        echo CHtml::label(Yii::t('yii','Institution code'), "institutioncodes", array("style"=>"width: 140px;"));
                        ?>
        ...
        <div class="tablerownewbox">
                <div class="tablefieldcelnewbox">
                    <div class="fieldnewbox">
                        <?php echo CHtml::activeTextField($institutioncodes,'institutioncode',array('size'=>48)); ?>
                    </div>
                </div>
    ...
    <div class="actionnewbox">
        ...
        <input type="button" value="<?php echo Yii::t('yii', "Create");?>" onclick="insertDataRecordLevelElements($('#institutioncode'),$('#recordlevelelements_idinstitutioncode'),'index.php?r=institutioncodes/create'+concatenarValoresUrlRecordLevelElements(),'institutioncode='+document.getElementById('institutioncodes_institutioncode').value)" >
   </div>
