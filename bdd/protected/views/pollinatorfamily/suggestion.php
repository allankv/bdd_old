<!-- Set names -->
<?php $field = 'Pollinator Family'; ?>
<?php $field_plural = 'Pollinator Families'; ?>

<script>
    $(document).ready(bootPollinatorFamily)

    function bootPollinatorFamily() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idpollinatorfamily;?>", "<?php echo $ar->pollinatorfamily; ?>", "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
