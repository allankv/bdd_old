<!-- Set names -->
<?php $field = 'Origin of seeds'; ?>
<?php $field_plural = 'Origins of seeds'; ?>

<script>
    $(document).ready(bootOriginSeeds)

    function bootOriginSeeds() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idoriginseeds;?>", "<?php echo $ar->originseeds; ?>");
        <?php endforeach; ?>
