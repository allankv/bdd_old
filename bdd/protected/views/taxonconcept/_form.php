<div class="yiiForm" style="background-color: transparent; border: none;">
        ...
        <div class="tablerownewbox">
            <?php echo CHtml::errorSummary($model); ?>
                ...
                <div class="tablelabelcelnewbox">
                    ...
                    <?php echo CHtml::label(Yii::t('yii','Taxon concept'), "taxonconcept",  array());?>
        ...
        <div class="tablerownewbox">
                <div class="tablefieldcelnewbox">
                    <div class="fieldnewbox">
                        <?php echo CHtml::activeTextField($model,'taxonconcept',array('rows'=>6, 'cols'=>50, 'size'=>48)); ?>
                    </div>
                </div>
    ...
    <div class="actionnewbox">
		...
		array('success'=>"alert('funfou o ajax')")
            ...
            <input type="button" value="<?php echo Yii::t('yii', "Create");?>" onclick="insertDataTaxonomicElements($('#taxonconcept'),$('#taxonomicelements_idtaxonconcept'),'index.php?r=taxonconcept/create'+concatenarValoresUrlTaxonomicElements(),'taxonconcept='+document.getElementById('taxonconcept_taxonconcept').value)" >
