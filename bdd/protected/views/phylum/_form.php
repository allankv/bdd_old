<div class="yiiForm" style="background-color: transparent; border: none;">
    ...
    <div class="tablenewbox">
        <div class="tablerownewbox">
            <?php echo CHtml::errorSummary($phylums); ?>

                <div class="tablelabelcelnewbox">
                    <div class="labelnewbox">
                        <?php //echo CHtml::activeLabelEx($phylums,'phylum');
                        echo CHtml::label(Yii::t('yii','Phylum'), "phylums");
                        ?>
        ...
        <div class="tablerownewbox">
                <div class="tablefieldcelnewbox">
                    <div class="fieldnewbox">
                        <?php echo CHtml::activeTextField($phylums,'phylum',array('rows'=>6, 'cols'=>50, 'size'=>48)); ?>
                    </div>
                </div>
    ...
    <div class="actionnewbox">
        ...
        <input type="button" value="<?php echo Yii::t('yii', "Create");?>" onclick="insertDataTaxonomicElements($('#phylum'),$('#taxonomicelements_idphylum'),'index.php?r=phylums/create'+concatenarValoresUrlTaxonomicElements(),'phylum='+document.getElementById('phylums_phylum').value)" >
   </div>
