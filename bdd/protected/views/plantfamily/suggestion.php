<!-- Set names -->
<?php $field = 'Plant Family'; ?>
<?php $field_plural = 'Plant Families'; ?>

<script>
    $(document).ready(bootPlantFamily)

    function bootPlantFamily() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idplantfamily;?>", "<?php echo $ar->plantfamily; ?>", "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
