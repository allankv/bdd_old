<!-- Set names -->
<?php $field = 'Contributor'; ?>
<?php $field_plural = 'Contributors'; ?>

<script>
    $(document).ready(bootContributor)

    function bootContributor() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idcontributor;?>", "<?php echo $ar->contributor; ?>", "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
