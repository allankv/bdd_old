<!-- Set names -->
<?php $field = 'Preparation'; ?>
<?php $field_plural = 'Preparations'; ?>
...
<script>
    ...
    function bootPreparation() {
        ...
        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idpreparation;?>", "<?php echo $ar->preparation; ?>",  "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
