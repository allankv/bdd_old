...
<script>
    ...
    function bootReference(){
        ...
        configCatComplete('#id','#searchField', 'referencePublic','#filterList');
        configIcons();
        filter();
        $("#printButton").button();
    ...
    function filter(senderValue){
        ...
        $.ajax({ type:'POST',
            url:'index.php?r=referencePublic/filter',
    ...
    function insertReferenceLine(rs){
        ...
        //var btnEdit = '<a href="index.php?r=referencePublic/goToMaintain&id='+rs.idreference+'"><img src="images/main/edit.png" style="border:0px;" title="Update"/></a> | ';
        ...
        //var btnEdit = '<ul id="icons"><li class="optionIcon ui-state-default ui-corner-all" title="Edit Reference Record"><a href="index.php?r=referencePublic/goToMaintain&id='+rs.idreference+'"><span class="ui-icon ui-icon-document"></span></a></li>';
        ...
        var btnShow = "<div class='btnShow' style='margin-left: 17px;'><a href='index.php?r=referencePublic/goToShow&id="+rs.idreference+"'><ul class='iconJQueryHover iconJQuery ui-widget ui-helper-clearfix'><li class='ui-state-default ui-corner-all' title='Show Reference Record'><span class='ui-icon ui-icon-search'></span></li></ul></a></div>";
       // var btnUpdate = "<div class='btnUpdate' style='margin-left: 0px;'><a href='index.php?r=referencePublic/goToMaintain&id="+rs.idreference+"'><ul class='iconJQueryHover iconJQuery ui-widget ui-helper-clearfix'><li class='ui-state-default ui-corner-all' title='Update Reference Record'><span class='ui-icon ui-icon-pencil'></span></li></ul></a></div>";
        ...
        if (related == 'no')
            ...
            content: function(updateCallback) {
                ...
                $.ajax({ type:'POST',
                url:'index.php?r=referencePublic/getTip',
    ...
    function print() {
	    ...
	    $.ajax({
        	type:'POST',
            url:'index.php?r=referencePublic/printList',
            data: {
            	'list':jFilterList, 
