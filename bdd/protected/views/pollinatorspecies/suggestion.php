<!-- Set names -->
<?php $field = 'Pollinator Species'; ?>
<?php $field_plural = 'Pollinator Species'; ?>

<script>
    $(document).ready(bootPollinatorSpecies)

    function bootPollinatorSpecies() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idpollinatorspecies;?>", "<?php echo $ar->pollinatorspecies; ?>", "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
