<div class="yiiForm" style="background-color: transparent; border: none;">
    ...
    <div class="tablenewbox">
        <div class="tablerownewbox">
            <?php echo CHtml::errorSummary($orders); ?>

                <div class="tablelabelcelnewbox">
                    <div class="labelnewbox">
                        <?php //echo CHtml::activeLabelEx($orders,'order');        
                        echo CHtml::label(Yii::t('yii','Order'), "institutioncodes");
                        ?>
        ...
        <div class="tablerownewbox">
                <div class="tablefieldcelnewbox">
                    <div class="fieldnewbox">
                        <?php echo CHtml::activeTextField($orders,'order',array('rows'=>6, 'cols'=>50,'size'=>48)); ?>
                    </div>
                </div>
    ...
    <div class="actionnewbox">
        ...
        <input type="button" value="<?php echo Yii::t('yii', "Create");?>" onclick="insertDataTaxonomicElements($('#order'),$('#taxonomicelements_idorder'),'index.php?r=orders/create'+concatenarValoresUrlTaxonomicElements(),'order='+document.getElementById('orders_order').value)" >
