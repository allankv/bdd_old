<!-- Set names -->
<?php $field = 'Keyword'; ?>
<?php $field_plural = 'Keywords'; ?>

<script>
    $(document).ready(bootKeyword)

    function bootKeyword() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idkeyword;?>", "<?php echo $ar->keyword; ?>", "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
