<!-- Set names -->
<?php $field = 'SupportType'; ?>
<?php $field_plural = 'SupportTypes'; ?>

<script>
    $(document).ready(bootSupportType)

    function bootSupportType() {

        <?php foreach($supporttypeList as $n=>$ar): ?>
            insertLine("<?php echo $ar->idsupporttype;?>", "<?php echo $ar->supporttype; ?>");
        <?php endforeach; ?>
