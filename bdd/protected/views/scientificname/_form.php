<div class="yiiForm" style="background-color: transparent; border: none;">
    ...
    <div class="tablenewbox">
        <div class="tablerownewbox">
            <?php echo CHtml::errorSummary($scientificnames); ?>

                <div class="tablelabelcelnewbox">
                    <div class="labelnewbox">
                        <?php //echo CHtml::activeLabelEx($scientificnames,'scientificname');
                        echo CHtml::label(Yii::t('yii','Scientific name'), "scientificnames");
                        ?>
        ...
        <div class="tablerownewbox">
                <div class="tablefieldcelnewbox">
                    <div class="fieldnewbox">
                        <?php echo CHtml::activeTextField($scientificnames,'scientificname',array('rows'=>6, 'cols'=>50, 'size'=>48)); ?>
                    </div>
                </div>
	...
	<?php //echo CHtml::submitButton($update ? 'Save' : 'Create'); ?>
        <input type="button" value="<?php echo Yii::t('yii', "Create");?>" onclick="insertDataTaxonomicElements($('#scientificname'),$('#taxonomicelements_idscientificname'),'index.php?r=scientificnames/create'+concatenarValoresUrlTaxonomicElements(),'scientificname='+document.getElementById('scientificnames_scientificname').value)" >
    </div>
