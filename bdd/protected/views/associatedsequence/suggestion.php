<!-- Set names -->
<?php $field = 'Associated Sequence'; ?>
<?php $field_plural = 'Associated Sequences'; ?>
...
<script>
    ...
    function bootAssociatedSequence() {
        ...
        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idassociatedsequence; ?>", "<?php echo $ar->associatedsequence; ?>",  "<?php echo $controllerItem; ?>", "<?php echo $controllerElement; ?>");
        <?php endforeach; ?>
