<div class="yiiForm" style="background-color: transparent; border: none;">
    ...
    <div class="tablenewbox">
        <div class="tablerownewbox">
            <?php echo CHtml::errorSummary($genus); ?>

                <div class="tablelabelcelnewbox">
                    <div class="labelnewbox">
                        <?php //echo CHtml::activeLabelEx($genus,'genus');
                        echo CHtml::label(Yii::t('yii','Genus'), "genus");
                        ?>
        ...
        <div class="tablerownewbox">
                <div class="tablefieldcelnewbox">
                    <div class="fieldnewbox">
                        <?php echo CHtml::activeTextField($genus,'genus',array('rows'=>6, 'cols'=>50, 'size'=>48)); ?>
                    </div>
                </div>
	...
	<?php //echo CHtml::submitButton($update ? 'Save' : 'Create'); ?>
        <input type="button" value="<?php echo Yii::t('yii', "Create");?>" onclick="insertDataTaxonomicElements($('#genus'),$('#taxonomicelements_idgenus'),'index.php?r=genus/create'+concatenarValoresUrlTaxonomicElements(),'genus='+document.getElementById('genus_genus').value)" >
    </div>
