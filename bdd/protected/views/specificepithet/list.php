<div class="table" style="width: 554px; background-color: #F4F4F4; margin-top:10px; margin-bottom:10px; -moz-border-radius-topleft: 1.0em; -moz-border-radius-topright: 1.0em; -moz-border-radius-bottomleft: 1.0em; -moz-border-radius-bottomright: 1.0em; border: 1px solid #ccc;">
    <div style="width: 554px; height: 80px;">
        ...
        <?php echo CHtml::image("images/help/iconelist.png","",array("style"=>"padding-left: 30px; padding-top: 20px ; float: left;")); ?>
            <div style="padding-left: 30px; padding-top: 20px ; float: left; color: #535353; font-size: 24px; font-family: Verdana;">
                <?php echo Yii::t('yii', "Specific epithets list");?>
            </div>
        </div>
    </div>
    ...
    <div style="width: 90%;padding-left: 30px; padding-bottom: 8px;" align="left">
        ...
        <?php echo Yii::t('yii', "View");?> : <a href="#" onclick="carregarPagina('index.php?r=specificepithets/list'+concatenarValoresUrlTaxonomicElements())" ><?php echo Yii::t('yii', "Filtered");?></a> &nbsp; <a href="#" onclick="carregarPagina('index.php?r=specificepithets/list&filtrar=no'+concatenarValoresUrlTaxonomicElements())" ><?php echo Yii::t('yii', "All");?></a>
        <?php }?>
    </div>
	...
	if ($specificepithetsList==null){
		...
		<?php
			if ($_GET["filtrar"]=="")
			{
				?>
				 ...
				 <a href="#" onclick="carregarPagina('index.php?r=specificepithets/list&filtrar=no'+concatenarValoresUrlTaxonomicElements())" ><?php echo Yii::t('yii', "Click here to see all the values");?></a>
				<?php
			}
		?>
            </div>
        ...
        <?php //echo CHtml::link($model->idspecificepithet,array('show','id'=>$model->idspecificepithet)); ?>
        <br/>
        <?php //echo CHtml::encode($model->getAttributeLabel('specificepithet')); ?>:
        <?php //echo CHtml::encode($model->specificepithet); ?>
        -->


	<tr style="width:500px; height: 30px;">
		<td style="border-right: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC;">
                    <span style="padding-left: 10px;"> <?php echo CHtml::encode($model->specificepithet); ?> </span>
		</td>
		<td style="text-align: center; border-bottom: 1px solid #CCCCCC; width: 100px;" >
		&nbsp;&nbsp<a href="#"  onclick="selecionaItemTaxonomicElements('specificepithet','<?php echo CHtml::encode($model->specificepithet); ?>',<?php echo CHtml::encode($model->idspecificepithet); ?>,'<?php echo $_GET["filtrar"];?>');" rel="selecionaritem" ><?php echo Yii::t('yii', "Select");?></a>
