<!-- Set names -->
<?php $field = 'Surroundings Vegetation'; ?>
<?php $field_plural = 'Surroundings Vegetations'; ?>

<script>
    $(document).ready(bootSurroundingsVegetation)

    function bootSurroundingsVegetation() {

        <?php foreach($listName as $n=>$ar): ?>
            insertLine("<?php echo $ar->idsurroundingsvegetation;?>", "<?php echo $ar->surroundingsvegetation; ?>");
        <?php endforeach; ?>
